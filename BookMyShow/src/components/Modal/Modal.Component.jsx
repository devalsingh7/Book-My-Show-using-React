...
const CustomModal = () => {
  ...
  //     console.warn("Google Login is disabled.");
  //     return;
  //   }
  //   googleLogin();
  // };
          ...
          <div className="min-h-screen flex items-center justify-center">
            ...
            >
              <div className="relative w-full max-w-md p-6 bg-white rounded-lg shadow-xl">
                ...
                <button
                  onClick={() => {
                    localStorage.clear(); // Clears localStorage as before
                    // Placeholder logic, replace with your actual logic if needed
                    console.log("Google login logic would go here.");
                    closeModal();
                  }}
